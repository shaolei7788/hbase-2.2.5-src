...
public class RpcServerFactory {
    ...
    public static RpcServer createRpcServer(final Server server, final String name, final List<BlockingServiceAndInterface> services,
    ...
    public static RpcServer createRpcServer(final Server server, final String name, final List<BlockingServiceAndInterface> services,
            final InetSocketAddress bindAddress, Configuration conf, RpcScheduler scheduler, boolean reservoirEnabled) throws IOException {
        ...
        for(BlockingServiceAndInterface s : services) {
            ...
            if(sd == null)
                continue; // Can be null for certain tests like TestTokenAuthentication
